...
export default function Sidebar({ activePage, onNavigate, shop, shopName, isOpen, stores = [], onSwitchStore, onStoreConnected, role }) {
  ...
  const navItems = [
    ...
    { section: 'Products', items: [
      { id: 'products', label: 'Products & Costs', icon: (
        <svg className="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
          <path d="M20.59 13.41l-7.17 7.17a2 2 0 01-2.83 0L2 12V2h10l8.59 8.59a2 2 0 010 2.82z"/>
          <circle cx="7" cy="7" r="1" fill="currentColor" stroke="none"/>
        </svg>
      )},
      { id: 'recommendations', label: 'Pricing & Margins', icon: (
        <svg className="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
    ...
    { section: 'Promotions', items: [
      { id: 'deals', label: 'Deal Simulator', icon: (
        <svg className="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
    ...
    { section: 'Account', items: [
      ...
      ...(role === 'admin' ? [{ id: 'support-admin', label: 'Support', icon: (
        <svg className="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
          ...
          {dropdownOpen && (
            <div style={{
              ...
              <div style={{
                ...
                <span style={{ width: 5, height: 5, borderRadius: '50%', background: 'var(--green)', display: 'inline-block', boxShadow: '0 0 5px rgba(16,185,129,0.6)' }} />
              ...
              {!connecting ? (
                ...
                >
                  <svg width="13" height="13" viewBox="0 0 13 13" fill="none">
                    <circle cx="6.5" cy="6.5" r="6" stroke="var(--accent-light)" strokeWidth="1.2"/>
                    <path d="M6.5 4v5M4 6.5h5" stroke="var(--accent-light)" strokeWidth="1.2" strokeLinecap="round"/>
                  </svg>
                  <span style={{ fontSize: '0.81rem', color: 'var(--accent-light)', fontWeight: 600 }}>Connect new store</span>
                </button>
              ) : (
