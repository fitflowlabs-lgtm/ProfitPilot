...
const icons = {
  ...
  settings: <svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M2 4.5h12M2 8h12M2 11.5h12" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" /><circle cx="5" cy="4.5" r="1.5" fill="var(--surface)" stroke="currentColor" strokeWidth="1.3" /><circle cx="10" cy="8" r="1.5" fill="var(--surface)" stroke="currentColor" strokeWidth="1.3" /><circle cx="6" cy="11.5" r="1.5" fill="var(--surface)" stroke="currentColor" strokeWidth="1.3" /></svg>,
