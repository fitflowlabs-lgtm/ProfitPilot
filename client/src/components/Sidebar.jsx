...
export default function Sidebar({ activePage, onNavigate, shop, shopName, isOpen, stores = [], onSwitchStore, onStoreConnected, role }) {
  ...
  const navItems = [
    ...
    { section: 'Account', items: [
      ...
      ...(role === 'admin' ? [{ id: 'support-admin', label: 'Support', icon: <svg className="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg> }] : []),
    ]},
  ]
